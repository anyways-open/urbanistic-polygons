...
namespace ANYWAYS.UrbanisticPolygons.IO
{
    ...
    internal static class BitCoder
    {
        ...
        internal static void WriteWithSize(this Stream stream, string? value, byte[]? buffer = null)
        {
            if (value == null)
            {
        ...
        internal static string? ReadWithSizeString(this Stream stream, byte[] buffer)
        {
